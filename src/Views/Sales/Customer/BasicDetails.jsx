...
import { getCurrencyFromLocalData } from '../../Helper/DateFormat';


const BasicDetails = ({ updateUserData, switchCusData, customerData, tick, setTick, dropdownRef1 }) => {
                            ...
                            <div id="fcx3s1parent">
                                ...
                                <div className="form_commonblockx3">
                                    ...
                                    <div id="fcx3s1">
                                        ...
                                        <span>
                                            <input type="input" autoFocus name="first_name" value={basicDetails.first_name} onChange={handleChange} placeholder={`Enter Customer First Name`} />
                                        </span>
                            ...
                            <div id="fcx3s1parent">
                                <div className="form_commonblock">
                                    ...
                                    <span>
                                        ...
                                        <NumericInput style={{ width: "100%" }} name="mobile_no" value={basicDetails.mobile_no} onChange={handleChange} placeholder="Enter Customer Mobile Number" />
                                    </span>
                                ...
                                <div className="form_commonblock">
                                    ...
                                    <div id="inputx1">
                                        <span>
                                            ...
                                            <NumericInput style={{ width: "100%" }} name="work_phone" value={basicDetails.work_phone} onChange={handleChange} placeholder="Enter Customer Work Phone" /></span>
                                    </div>
                                </div>
                            </div>
                            <div className="height5"></div>
                                    ...
                                    <div className="form_commonblock">
                                        ...
                                        <div id="inputx1">
                                            <span>
                                                ...
                                                <NumericInput style={{ width: "100%" }} name="gst_no" value={basicDetails.gst_no} onChange={handleChange} placeholder="Enter GST Number" /></span>
                                        </div>
