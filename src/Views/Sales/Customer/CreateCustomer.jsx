...
const CreateCustomer = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!tick?.basicTick) {
      if (!scrollToTop(dropdownRef1.current)) {
          ...
          <DisableEnterSubmitForm onSubmit={handleSubmit}>
            <div className="itemsformwrap">
              <div id="">
                ...
                {/* main forms */}
                <BasicDetails text1={text1} switchCusData={switchCusData} customerData={{ user, isEdit, isDublicate }} setTick={setTick} tick={tick} updateUserData={updateUserData} dropdownRef1={dropdownRef1} />
