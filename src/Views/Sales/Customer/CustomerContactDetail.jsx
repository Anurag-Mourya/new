                    ...
                    <div className="form_commonblock">
                      ...
                      <div id="inputx1">
                        <span>
                          ...
                          <NumericInput value={person.mobile_no} onChange={(e) => handleChange("mobile_no", index, e.target.value)} placeholder="Enter Mobile Number" name="mobile_no" />
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="form_commonblock">
                      ...
                      <div id="inputx1">
                        <span>
                          ...
                          <NumericInput value={person.work_phone} onChange={(e) => handleChange("work_phone", index, e.target.value)} placeholder="Enter Work Phone" name="work_phone" />
