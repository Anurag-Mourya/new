                ...
                <div id="Anotherbox">
                    ...
                    <div id="buttonsdata">
                        <div className="maincontainmiainx1">
                            <div data-tooltip-content="Sort By" data-tooltip-id="my-tooltip" className="filtersorticos5w" id="sortByButton" data-tooltip-place="bottom" onClick={handleSortByDropdownToggle}>
                        ...
                        <Link className="linkx1" to={"/dashboard/create-purchases"} data-tooltip-content="New Purchase" data-tooltip-id="my-tooltip" data-tooltip-place="bottom">
                            New Purchase <GoPlus />
                        </Link>
                                        ...
                                        >
                                            ...
                                            <div onClick={() => handleRowClicked(quotation)} className="table-cellx12 quotiosalinvlisxs6 sdjklfsd565">
                                                ...
                                                <p className={quotation?.status === "1" ? "open" : quotation?.status === "0" ? "draft" : quotation?.status == "2" ? "close" : quotation?.status === "3" ? "pending" : quotation?.status === "4" ? "overdue" : ""}>
                                                    ...
                                                    {quotation?.status === "0" ? "Draft" : quotation?.status === "1" ? "Approved" : quotation?.status == "2" ? "Close" : quotation?.status == "3" ? "Pending" : quotation?.status == "4" ? "Overdue" : ""
                                                    }
                                                </p>
                                            </div>
