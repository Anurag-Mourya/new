            ...
            <div id="Anotherbox" className='formsectionx1'>
                ...
                <div id="buttonsdata">
                    ...
                    <div className={`maincontainmiainx1`}>
                        ...
                        <div className="filtersorticos5w labelfistc51s" id="filterButton" onClick={handleFilterDropdownToggle}>
                ...
                <div id="middlesection">
                    <div id="mainsectioncsls">
                        <div id="leftsidecontentxls">
                            <div id="item-listsforcontainer" className="listsectionsgrheigh" style={{ height: "unset" }}>
                                            ...
                                            <>
                                                {cusList?.data?.user?.map((quotation, index) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div onClick={() => handleRowClicked(quotation)} className="table-cellx12 x125cd02" data-tooltip-content={quotation.company_name || ""} data-tooltip-id="my-tooltip">
