...
export const getCurrencyFromLocalData = () => {
    const getCurrencyValue = localStorage?.getItem("UserData");
    const userDataCurrency = JSON.parse(getCurrencyValue);
    return userDataCurrency?.active_organisation?.currency.toUpperCase()
}



export const getCurrencyFormData = () => {
    const getCurrencyValue = localStorage?.getItem('UserData')
    const UserCurrencyVlaue = JSON.parse(getCurrencyValue)
    if (UserCurrencyVlaue == '') {
        return UserCurrencyVlaue.currency.toUpperCase()
    } else {
        return 'INR'
    }
    // return 'INR'
