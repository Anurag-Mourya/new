...
const GRN = () => {
    ...
    useEffect(() => {
        const areAllRowsSelected = grnLists?.grn?.every((row) => selectedRows.includes(row.id));
                ...
                <div id="Anotherbox">
                    ...
                    <div id="buttonsdata">
                        <div className="maincontainmiainx1">
                            <div data-tooltip-content="Sort By" data-tooltip-id="my-tooltip" className="filtersorticos5w" id="sortByButton" data-tooltip-place="bottom" onClick={sortByDropdown.handleToggle}
                        ...
                        <div className="maincontainmiainx1">
                            <div data-tooltip-content="Filter" data-tooltip-id="my-tooltip" data-tooltip-place="bottom" className="filtersorticos5w" id="filterButton" onClick={filterDropdown.handleToggle}
                                    ...
                                    {grnLists?.grn?.map((quotation, index) => (
                                        <div
                                            ...
                                            <div onClick={() => handleRowClicked(quotation)} className="table-cellx12 quotiosalinvlisxs4">
                                                {quotation.purchase_order?.purchase_order_id == 0 ? "" : quotation.purchase_order?.purchase_order_id || ""}
                                            </div>
                                            ...
                                            <div onClick={() => handleRowClicked(quotation)} className="table-cellx12 quotiosalinvlisxs6 sdjklfsd565">
                                                ...
                                                <p className={quotation?.status === "1" ? "open" : quotation?.status === "0" ? "draft" : quotation?.status == "2" ? "close" : quotation?.status === "3" ? "pending" : quotation?.status === "4" ? "overdue" : ""}>
                                                    ...
                                                    {quotation?.status === "0" ? "Draft" : quotation?.status === "1" ? "Bill Created" : quotation?.status == "2" ? "Close" : quotation?.status == "3" ? "Sent For Approval" : quotation?.status == "4" ? "Overdue" : ""}
                                                </p>
                                            </div>
