...
export const createExpenses = (queryParams, Navigate, dublicate) => async (dispatch) => {
    // console.log("queryParams", queryParams)
    ...
    try {
        ...
        if (response?.data?.Expense === "Expense Created Successfully" && !dublicate) {
        ...
        } else if (response?.data?.Expense === "Expense Created Successfully" && dublicate === "dublicate") {
            toast.success("Expense Dublicated Successfully");
            Navigate("/dashboard/expenses");
        }
